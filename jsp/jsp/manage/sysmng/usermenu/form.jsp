<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
                ...
                <div class="tree-content">
                    ...
                    <div id="mng_menu_tree" class="list-jqtree">
                    <p>asdasdasd</p>
                    </div>
                        ...
                        <fieldset>
                            ...
                            <table class="table-detail mb-7">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><label for="form-item2">링크 타겟</label></th>
                                        <td>
                ...
                <div class="tree-content">
                	<br /><br />※ 좌측 메뉴명을 클릭하면 해당 메뉴의 상세 정보를 수정할 수 있습니다.<br />
                	※ 좌측 메뉴명을 마우스 우측 버튼으로 클릭하면 새 메뉴를 추가할 수 있습니다.
                </div>
		                ...
		                $('#mng_menu_tree').jstree({
		        			...
		        			'contextmenu': {
		        				"items": function($node) {
		        					...
		        					if($node.parents.length>1){delete ctxMenu.Create;}
		        					return ctxMenu;
		        				}
		        			},
		        			'dnd': {
