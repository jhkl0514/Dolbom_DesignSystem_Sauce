<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
				...
				<p class="mt-7 text-gray1">
                    ...
                    * 멤버스 승인 된 주문은 <strong class="text-primary">주문 승인완료 목록으로 이동</strong>합니다.
                </p>
                </c:if>

                <c:if test="${ordrSttsTy eq 'OR02' }">
				<p class="mt-7 text-gray1">
                    * 주문 승인완료는 급여 상품만 적용됩니다.<br>
                    * 멤버스 승인 후 결제가 진행된 주문은 <strong class="text-primary">결제대기 또는 결제완료 목록으로 이동</strong>합니다.
                </p>
                </c:if>

               	<c:if test="${ordrSttsTy eq 'OR03' }">
				<p class="mt-7 text-gray1">
                    * 주문 승인반려는 급여 상품만 적용됩니다.<br>
                    * 멤버스 반려 후 취소가 진행된 주문은 <strong class="text-primary">취소관리 목록으로 이동</strong>합니다.
                </p>
                </c:if>
                        ...
                        <tbody>
			                ...
			                <tr>
                                ...
                                <td class="${resultList.ordrCd}">
                                	...
                                	<a class="btn shadow" href="/_mng/partners/bplc/view?uniqueId=${resultList.bplcUniqueId}" target="_blank">${resultList.bplcInfo.bplcNm}</a>
                                		</c:when>
                ...
                $(function(){
                	// 회원 상세 > 주문 상세
                	/*
                	if("${param.orddrCd}" != null){
                		var ordrCd = "${param.orddrCd}";
                	...
                	*/
                	...
                	$(document).on("click", ".f_optn_chg", function(){
                		...
                		$("#ordr-optn").load("/_mng/ordr/include/optnChg",
               				{ordrDtlNo:ordrDtlNo
	                			, gdsNo:gdsNo
	                			, ordrDtlCd:ordrDtlCd
                			}, function(){
                	...
                	$(document).on("click", ".f_ordr_rtrcn", function(){
                		...
                		$("#ordr-rtrcn").load("/_mng/ordr/include/ordrRtrcn",
               				{ordrCd:ordrCd
                			}, function(){
	            	...
	            	$(document).on("click", ".f_gds_exchng", function(e){
	            		...
	            		const ordrDtlCd = $(this).data("dtlCd");
                		$("#ordr-exchng").load("/_mng/ordr/include/ordrExchng",
	            	...
	            	$(document).on("click", ".f_gds_return", function(e){
	            		const ordrCd = $(this).data("ordrCd");
                		$("#ordr-return").load("/_mng/ordr/include/ordrReturn",
               				{ordrCd:ordrCd
                			}, function(){
                	...
                	$(document).on("click", ".f_ordr_stts_hist", function(){
                		const ordrDtlNo = $(this).data("dtlNo");
                		$("#ordr-stts-hist").load("/_mng/ordr/include/ordrSttsHist",
               				{ordrDtlNo:ordrDtlNo
                			}, function(){
                	...
                	$(document).on("click", ".f_ordr_dtl_confrm", function(){
                		const ordrDtlNo = $(this).data("dtlNo");
                		$("#ordr-stts-hist").load("/_mng/ordr/include/ordrConfm",
               				{ordrDtlNo:ordrDtlNo
                			}, function(){
	        		...
	        		var excelFileSubject = '';
	        		
	        		$(".btn-excel").on("click", async function(){
	        			
	        			<%-- 주문 메뉴명에 따라 엑셀파일명 처리--%>
	        			excelFileSubject = getExcelFileSubject('${ordrSttsTy}');
	        		...
	        		async function downloadExcel() {
	        			...
	        			jsCallApi.call_api_post_json_formData(window, "excel.json", excelDownloadCallback, data);
                ...
                function getExcelFileSubject(ordrSttsTy) {

        		    switch (ordrSttsTy.toUpperCase()) {
        		        case 'ALL':
        		            excelFileSubject = '전체_주문_목록_';
        		            break;
        		        case 'OR01':
        		            excelFileSubject = '승인대기_주문_목록_';
        		            break;
        		        case 'OR02':
        		            excelFileSubject = '승인완료_주문_목록_';
        		            break;
        		        case 'OR03':
        		            excelFileSubject = '승인반려_주문_목록_';
        		            break;
        		        case 'OR04':
        		            excelFileSubject = '결제대기_주문_목록_';
        		            break;
        		        case 'OR05':
        		            excelFileSubject = '결제완료_주문_목록_';
        		            break;
        		        case 'OR06':
        		            excelFileSubject = '배송관리_주문_목록_';
        		            break;
        		        case 'OR09':
        		            excelFileSubject = '구매확정_주문_목록_';
        		            break;
        		        case 'CA01':
        		            excelFileSubject = '취소관리_주문_목록_';
        		            break;
        		        case 'EX01':
        		            excelFileSubject = '교환관리_주문_목록_';
        		            break;
        		        case 'RE01':
        		            excelFileSubject = '반품관리_주문_목록_';
        		            break;
        		        case 'RF01':
        		            excelFileSubject = '환불관리_주문_목록_';
        		            break;
        		        default:
        		            excelFileSubject = '기타';
        		            break;
