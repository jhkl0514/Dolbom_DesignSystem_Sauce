...
<%-- 주문진행 내역 --%>
                        ...
                        <div class="modal-body">
                            ...
                            <table class="table-list mt-10 ordr-stts-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="${chgHist.chgStts}">${ordrSttsCode[chgHist.chgStts]}</td>
                                        <td class="${chgHist.chgStts}">
                                        	<c:choose>
                                        ...
                                        <td class="${chgHist.chgStts}">${chgHist.regId} (${chgHist.rgtr})</td>
                                        <td class="${chgHist.chgStts}"><fmt:formatDate value="${chgHist.regDt}" pattern="yyyy-MM-dd HH:mm" /></td>
                                    </tr>
                                    </c:forEach>
            ...
            <script>
            $(function(){
            	$(".ordr-stts-list").mergeClassRowspan(0);
            	$(".ordr-stts-list").mergeClassRowspan(1);
            	$(".ordr-stts-list").mergeClassRowspan(2);
            	$(".ordr-stts-list").mergeClassRowspan(3);
