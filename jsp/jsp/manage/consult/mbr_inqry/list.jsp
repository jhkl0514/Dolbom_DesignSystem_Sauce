...
<div id="page-content">
	...
	<table class="table-list">
		...
		<c:set var="pageParam" value="inqryNo=${resultList.inqryNo}&amp;menuNo=${param.menuNo}&amp;ansYn=${resultList.ansYn}&amp;curPage=${listVO.curPage }&amp;cntPerPage=${param.cntPerPage }&amp;srchRegBgng=${param.srchRegBgng}&amp;srchRegEnd=${param.srchRegEnd}
