...
// 엑셀 파일명 설정
String fileName = "포인트_" + EgovDateUtil.getCurrentDateAsString();
try {
		...
		<table class="table-list">
			...
			<thead>
				<tr>
					...
					<th scope="col" rowspan="2">적립포인트</th>
				</tr>
				<tr>
					<th scope="col">포인트 사용 주문건수</th>
					<th scope="col">사용 포인트</th>
					<th scope="col" class="nolast">포인트 사용 결제 금액</th>
				</tr>
			</thead>
			<tbody>
