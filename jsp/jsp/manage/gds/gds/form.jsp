		...
		display: none;
                ...
                <script>
                    ...
                    $(function(){
						...
						(new JsCKEditorHelperOnline()).init('#gdsDc');
						(new JsCKEditorHelperOnline()).init('#aditGdsDc');
						(new JsCKEditorHelperOnline()).init('#memo');
						(new JsCKEditorHelperOnline()).init('#dlvyDc');
						(new JsCKEditorHelperOnline()).init('#dcCmmn');
						(new JsCKEditorHelperOnline()).init('#dcFreeSalary');
						(new JsCKEditorHelperOnline()).init('#dcPchrgSalary');
						(new JsCKEditorHelperOnline()).init('#dcPchrgSalaryGnrl');
						(new JsCKEditorHelperOnline()).init('#dcPchrgGnrl');
