    ...
    <header id="header">
        ...
        <nav id="navigation">
            <ul class="menu-items">
				...
				<li><a href="${mngMenu.menuUrl}?menuNo=${mngMenu.menuNo}" class="menu-${mngMenu.icon} ${mngMenu.menuNo eq _mngMenuPathList[1] ? ' active' : ''}"">${mngMenu.menuNm}</a></li>
            			</c:when>
            			<c:otherwise>
            ...
            <div class="list-items ${mngMenu.menuNo eq _mngMenuPathList[1] ? ' active' : ''}" id="list-items${mngMenu.menuNo}">
            	...
            	<c:if test="${mngMenu.levelNo eq '3'}">
                    ...
                    <li ${mngMenu.menuNo eq _mngMenuPathList[2] ? 'class="active"' : ''}>
                    	<a href="${mngMenu.menuUrl}?menuNo=${mngMenu.menuNo}">${mngMenu.menuNm}<%--  // ${mngMenu.menuNo} // ${mngMenu.upMenuNo} // ${mngMenu.childCnt } --%></a>
				...
				<c:if test="${mngMenu.levelNo eq '4'}">
					<li><a href="${mngMenu.menuUrl}?menuNo=${mngMenu.menuNo}">${mngMenu.menuNm}</a></li>
				</c:if>
