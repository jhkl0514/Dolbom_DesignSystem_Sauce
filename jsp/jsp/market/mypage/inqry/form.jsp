...
<main id="container" class="is-mypage">
	...
	<div id="page-container">
		...
		<div id="page-content">
            ...
            <form:form action="./action" class="mt-4 md:mt-5" id="inqryFrm" name="inqryFrm" method="post" modelAttribute="inqryVO" enctype="multipart/form-data">
	            ...
	            <fieldset class="mypage-inquiry mt-2.5 md:mt-3">
	                ...
	                <div class="inquiry-top">
	                    <table>
	                        ...
	                        <tr>
	                            <th scope="row">고객명</th>
	                            <td><strong>${_mbrSession.mbrNm}</strong></td>
	                        </tr>
	                        <tr>
	                            ...
	                            <td class="space-y-2 md:space-y-3">
	                                <div class="form-group">
	                                    ...
	                                    <form:input class="form-control" path="mblTelno" maxlength="13" value="${_mbrSession.mblTelno}"/>
	                                </div>
	                                <div class="form-group">
	                                    <div class="form-check">
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                    ...
	                                    <div class="form-upload attachView" style="display:none;">
	                                     ...
	                                     --%>
	                                    <input type="file" id="attachFile" name="attachFile" ${fn:length(inqryVO.fileList) > 0 ? 'style="display:none;' : '' }" class="form-control w-full">

	                                    <c:forEach var="fileList" items="${inqryVO.fileList}" varStatus="status">
	                ...
	                <div class="mt-8 text-center md:mt-9">
	                    <button type="submit" class="btn btn-large btn-primary w-46 md:w-53">저장</button>
						<a href="${_marketPath}/mypage/inqry/list" class="btn btn-large">취소</a>
	                </div>
	            </fieldset>
			</form:form>
		</div>
...
function f_inqryTyChg(idx){
	...
	$(function() {
		...
		//알림서비스 비활성화, 첨부파일 활성화
		if ("${inqryVO.crud}" == "CREATE") {
			if($("${_mbrSession.mblTelno}" != null)){
				$("#mblTelno").attr("disabled", false);
				$("#mblTelno").val("${_mbrSession.mblTelno}");
				$("#telnoChk").prop("checked",true);
				$("#telnoChk").val("Y");
			}
			if($("${_mbrSession.eml}" != null)){
				$("#eml").attr("disabled", false);
				$("#eml").val("${_mbrSession.eml}");
				$("#emlChk").prop("checked",true);
				$("#emlChk").val("Y");
			}
