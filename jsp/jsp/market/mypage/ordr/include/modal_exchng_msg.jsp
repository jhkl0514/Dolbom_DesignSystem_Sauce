<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        <!-- 교환 상세정보 -->
        <div class="modal fade" id="exchng-msg" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <p class="text-title">교환 상세정보</p>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="order-status-layer">
                            ...
                            <ul class="status-steps mt-4 md:mt-5.5">
                                <li class="seq1 ${ordrDtlList[0].sttsTy eq 'EX01'?'active':'' }"><p>교환<strong>신청</strong></p></li>
                                <!-- <li class="seq2"><p>교환 <strong>접수승인</strong></p></li> -->
                                <li class="seq3 ${ordrDtlList[0].sttsTy eq 'EX02'?'active':'' }"><p>교환 <strong>진행중</strong></p></li>
                                <li class="seq4 ${ordrDtlList[0].sttsTy eq 'EX03'?'active':'' }"><p>교환 <strong>완료</strong></p></li>
                            </ul>
                            ...
                            <dl class="status-info mt-2 md:mt-3">
                                <dt>교환 사유</dt>
                                <dd>
                                    ${ordrExchngTyCode[ordrChgHistVO.resnTy]}
