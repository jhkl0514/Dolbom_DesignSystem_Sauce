...
<main id="container">
	<h2 id="page-title">휴면계정 해제</h2>

	<div id="page-container">
		<div id="page-content">
			<div class="member-release-title">
				<img src="/html/page/market/assets/images/txt-sleep3.svg" alt="회원님의 계정이 휴면해제 되었습니다.">
			...
			<div class="text-center mt-12 md:mt-16">
				<a href="${_marketPath}/login" class="btn btn-large btn-primary w-62 md:w-75">로그인 하기</a>
			</div>
		</div>
	</div>
</main>