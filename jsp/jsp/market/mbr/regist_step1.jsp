			...
			<div class="member-join">
				<div class="member-join-container">
					<div class="member-join-step1">
						<img src="/html/page/market/assets/images/txt-join-number1.svg" alt="STEP 1">
					</div>
					<form id="frmStep1" name="frmStep1" action="./registStep2" class="member-join-content" method="post" enctype="multipart/form-data">
						...
						<div class="content-accordion" id="accordionAgree">
							<div class="accordion-item">
								<div class="accordion-header">
									...
									<button type="button" class="accordion-button" data-bs-target="#collapse-agree1" data-bs-toggle="collapse" aria-expanded="false" id="mbrBtn">펼치기/접기</button>
							...
							<div class="accordion-item">
								<div class="accordion-header">
									...
									<button type="button" class="accordion-button" data-bs-target="#collapse-agree2" data-bs-toggle="collapse" aria-expanded="false">펼치기/접기</button>
								</div>
							...
							<div class="accordion-item">
								<div class="accordion-header">
									<div class="form-check">
										<input class="form-check-input" type="checkbox" id="thirdChk">
										<label class="form-check-label" for="thirdChk"> <span class="text-danger">필수</span> 맴버십 서비스 약관에 동의합니다
										</label>
									</div>
									<button type="button" class="accordion-button" data-bs-target="#collapse-agree3" data-bs-toggle="collapse" aria-expanded="false">펼치기/접기</button>
								</div>
						...
						<div class="content-auth-phone mt-9">
							...
							<%--임시 작업 --%>
							<%--
							이름 : <input type="text" id="mbrNm" name="mbrNm" value="테스트" class="form-control"><br>
							휴대폰 : <input type="text" id="mblTelno" name="mblTelno" value="010-0000-" class="form-control"><br>
							성별(M/W) : <input type="text" id="gender" name="gender" value="M" class="form-control"><br>
							생일 : <input type="text" id="brdt" name="brdt" value="1999-01-01" class="form-control"><br>
							 --%>
					...
					<div class="member-join-sidebar is-right is-process">
						<p class="text">
							<span>STEP 2</span>
						</p>
					</div>
