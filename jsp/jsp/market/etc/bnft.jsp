	            ...
	            <div class="benefit-container">
	                ...
	                <div class="py-6 mx-4 md:mx-5 md:py-8 md:px-5 lg:px-9">
	                    <dl class="text-alert is-danger">
	                        ...
	                        <dd class="text-black2 mt-1.5">
	                            <ul class="list-normal">
	                                ...
	                                <li>마일리지는 3,000M 부터 10원 단위 사용 가능합니다.(최대 50,000M, 포인트와 중복 사용 가능)</li>
	                    ...
	                    <dl class="text-alert is-danger mt-6 md:mt-7">
	                        ...
	                        <dd class="text-black2 mt-1.5">
	                            <ul class="list-normal">
	                                <li>적립한 포인트는 일반상품 (급여상품 제외) 구매시 사용 가능합니다. (마일리지와 중복 사용 가능)</li>
	                                <li>포인트는 3,000P 부터 10원 단위 사용 가능합니다. (최대 50,000P)</li>
	                                <li>
