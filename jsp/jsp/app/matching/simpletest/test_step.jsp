...
<div class="wrapper">
    ...
    <main>
        ...
        <section class="default">
            ...
            <progress class="progress01" value="${stepIdx}" min="0" max="7"></progress>
            <div class="progress_num"><span class="step">${stepIdx}</span>/7</div>
...
<script>
    ...
    async function fn_save_result_cb(result){
        if (result != null && result.errorMsg != undefined && result.errorMsg.length > 0){
            ...
            saveInLocalStorage('testComplete', 'Y');
