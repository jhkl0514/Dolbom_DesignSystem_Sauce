...
<div class="wrapper">
    ...
    <main>
        <section class="default">
            ...
            <div class="box_om_wel_list title">
                <div class="img_area">
                    <img src="${nttVO.addValueText02}" alt="${nttVO.addValueText03}">
                </div>
                <h4 class="title">
                    ${nttVO.ttl}
                </h4>
...
<script>
    function fn_tel_click(tel){
        if (tel == undefined || tel.length < 1) return ;
