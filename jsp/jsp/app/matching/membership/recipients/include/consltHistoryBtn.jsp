...
<a class="d-flex align-items-center justify-content-end marT4 marB4" href="/matching/membership/conslt/list?recipientsNo=${recipientNo}">
    <span class="color_t_s font_sbsr">상담내역 보기</span>
