<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	    ...
	    <script>
	    	...
	    	function setAgreementModalForEroum(type, termsNo) {
	    		var content = '<iframe src="/matching/terms/' + termsNo + '" width="100%" height="98%" style="border:none;"></iframe>';
	    	...
	    	function setAgreementModalForDanal(type, carrierCode) {
	    		...
	    		var content = '<iframe src="' + src + '" width="100%" height="98%" style="border:none;"></iframe>';
	    		setAgreementModal(type, content);
	    	}
	    </script>
