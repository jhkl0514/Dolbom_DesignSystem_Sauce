...
<div id="content">
	<div class="grade-content1 welfare-equip">
        ...
        <p class="mt-10 grade-text2">
            <strong class="font-bold text-hightlight-orange">필요한 복지용구</strong>를 선택하고 상담하면<br>
            <strong class="font-bold text-hightlight-orange">받을 수 있는 혜택</strong>을 알려드려요
        </p>
        <div class="grade-start mt-11 md:mt-15">
            <div class="picture">
                ...
                <button class="btn-welfare btn btn-large2 btn-primary2 btn-arrow" data-bs-toggle="modal" data-bs-target="#dbapp_modal">
    ...
    <div class="text-xl text-center md:text-4xl">
        <span class="font-bold text-hightlight-orange">필요한 복지용구</span>를 선택한 후<br>
        <span class="font-bold text-hightlight-orange">받을 수 있는 혜택</span>을 알려드려요
    </div>

	<div class="grade-floating">
		<button data-bs-toggle="modal" data-bs-target="#dbapp_modal">
			<strong>앱 다운받고 신청하기</strong>
		</button>
	</div>
