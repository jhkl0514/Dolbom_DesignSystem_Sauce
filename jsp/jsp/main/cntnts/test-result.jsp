...
<div id="content">
    ...
    <div class="result-content2">
        <h2 class="grade-title">
            ...
            <c:if test="${_mbrSession.loginCheck}">
            	<small>이로움돌봄 앱 다운받고</small>
            	<small>무료 전문가 상담으로 등급 신청하세요</small>	
            </c:if>
            <c:if test="${!_mbrSession.loginCheck}">
    ...
    <div class="result-content3">
        <h2 class="grade-title">
            ...
            <c:if test="${_mbrSession.loginCheck}">
	            <small>
	                테스트 결과, 현재 상황에 도움이 될 복지용구예<br>
	                요. 이로움돌봄 앱 다운받고 신청하세요.
	            </small>
	            <c:if test="${!_mbrSession.loginCheck}">
            		<small>
    ...
    <div class="grade-floating">
    	<button class="btn btn-large2 btn-primary2 btn-arrow" onClick="handleAppDownButtonClick()">
            <strong>앱 다운받고 신청하기</strong>
        </button> 
    </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn large btn-primary2 w-70 md:w-50" onClick="sendEmailAndShowAppModal()")>전송하기</a>
                        </div>
                    </div>
                </div>
            </div>
...
//             		alert('통신중 오류가 발생하였습니다.');
          	...
          	function drawMbrTestSelectResult() {
          		...
          		if (testResult.grade !== 0) {
          			...
          			if(testResult.diseaseSelect1 && testResult.diseaseSelect1[0] 
          				...
          				$('.grade-floating').css('display', 'none');
          			}
          		}
          	}
        ...
        function sendEmailAndShowAppModal() {
        	...
        	if (!testData) {
      		...
      		$.ajax({
      			type: "post",
      			url: "/test/send/email.json?email=" + email,
            ...
            $('#modal-email').modal('hide');
      		$('#dbapp_modal').modal('show');
        }
      	
      	function handleAppDownButtonClick() {
