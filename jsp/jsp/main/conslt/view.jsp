...
<div id="content">
	<div class="mx-auto max-w-[800px]">
		...
		<div class="text-center">
			...
			<p class="mt-5.5 text-lg font-bold md:mt-6 md:text-xl lg:mt-7 lg:text-2xl">상담 신청이 완료되었어요.</p>
            <p class="mt-5 text-sm font-bold md:mt-6 md:text-base lg:mt-7 lg:text-lg">
                "영업일 기준 2일 이내 해피콜 통해<br>
                안내 받을 수 있어요."
            </p>
			<a href="${_membershipPath}/conslt/appl/list" class="btn btn-large btn-primary3 mt-15 w-57 md:mt-20 md:w-70 lg:mt-25">상담 현황 보기</a>
		</div>
