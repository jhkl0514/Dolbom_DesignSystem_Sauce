...
<style>
	...
	/* 개인정보 이용약관 등 불러올때 기존 여백 제거 */
	.accordion-body{padding: 0 !important;}

	/* 체크박스 텍스트라인 강제로 넘어가기 방지 */
	.form-check.warning.flex_imfortant{display: flex !important;}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body"> 
                        <div class="flex flex-col gap-10">
                            <div>
                                <div class="flex flex-col gap-2 mb-1 sm:flex-row sm:justify-between sm:items-end">
                                ...
                                <div class="flex flex-col gap-4 bg-box-beige">
                                	<!-- 가족일 때 -->
                                	<div class="flex items-start gap-2 text-lg md:whitespace-nowrap" id="roc-main-div-rel-family">
                                        <img src="/html/page/members/assets/images/img-senoir-mono.svg" alt="시니어얼굴" class="icon-senior img_resp_hidden"/>
                                    ...
                                    <div class="flex items-start gap-2 text-lg md:whitespace-nowrap" id="roc-main-div-lno-yes">
                                        <img src="/html/page/members/assets/images/img-nhis.svg" alt="국민건강보험 심볼" class="w-5 mt-1 img_resp_hidden"/>
                                        <div class="flex flex-wrap items-center gap-1">
                                    ...
                                    <!--요양정보가 없을때-->
                                    <div class="flex flex-col items-start gap-2 text-lg sm:flex-row md:whitespace-nowrap" id="roc-main-div-lno-no">
                                            ...
                                            <div class="flex items-start gap-1">
                                                ...
                                                <div class="w-full">
                                                    <label for="roc-rcpt-lno" class="rcpt-lno type2">
                                                        ...
                                                        class="form-control keycontrol numberpositive" maxlength="10" 
                            ...
                            <div class="flex flex-col gap-4">
                                <h3 class="-mb-3 text-lg font-medium">상담 시 필요 정보</h3>
                                <div class="table-box">
                                    <table>      
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="roc-main-td-rel-family">
                                                    <fieldset class="flex flex-col w-full gap-1 md:flex-row">
								...
								<div class="agree_area">
									...
									<div class="font_18_1 text-black2">상담을 위해 동의가 필요해요</div>
									<div class="font_14_1 c666666">연결된 장기요양기관에서 준비할 서류부터 신청 방법을 안내 드려요.</div>
									
									<div class="h16"></div>

									<div class="group_chk_area">

										<div class="form-check warning flex_imfortant" id="roc-main-conslt-aggree-div">
											<input class="form-check-input" type="checkbox" id="roc-main-agree-check" onchange="checkActionBtnDisabled();">
											<label class="form-check-label" for="roc-main-agree-check">[필수] 개인정보 3자제공 동의(상담신청)</label>
										</div>

										<div class="arrow_right" data-bs-toggle="modal" data-bs-target="#modal_cons_provide"></div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="roc-main-action-btn" class="flex-1 btn-warning large2 md:flex-none md:w-1/3" onclick="startActionInRocModal();"></button>
                    </div>
                </div>
            </div>
        </div>
		...
		<!-- todo OEOS-601 -->
        <!--개인정보 3자제공 동의-->
        <div class="modal modal-default fade" id="modal_cons_provide" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg min-w-lg">
                <div class="modal-content">
                    <div class="modal-header marB0">

                        <h2 class="flex justify-start text-title">
							<div class="btn_back" data-bs-toggle="modal" data-bs-target="#roc-main-modal"></div>
							개인정보 3자제공 동의
						</h2>
                        <button data-bs-dismiss="modal" class="btn-close">모달 닫기</button>
                    </div>
                    ...
                    <div class="modal-body"> 
						...
						<div class="accordion-body py-3.5 px-4">
							...
							<div class="flex justify-end">
								<select name="" id="ccc" class="form-control form-small">
									<option value="">이전 버전 보기</option>
									<option value="">2024년 12월 31일</option>
									<option value="">2023. 11.2</option>
								</select> 
							</div>
							...
							<table class="terms-table mt-1.5">
								...
								<tbody>
									<tr>
										<th scope="col" class="text-left">제공 목적</th>
										<td>복지용구 상담, 장기요양 인정등급 상담 및 서비스 제공</td>
									</tr>
									<tr>
										<th scope="col" class="text-left">제공 항목</th>
										<td>이름, 아이디, 수급자 정보, 수급자와의 관계, 수급자 성명,
											장기요양인정번호, 생년월일, 성별, 제공하는 서비스 결과(인정등급테스트, 관심복지용구, 어르신돌봄 등)
										</td>
									</tr>
									<tr>
										<th scope="col" class="text-left">제공받는 자</th>
										<td>복지용구 사업소 (제공받는자는 신청자의 주소지에 따라 상이 할 수 있음)</td>
									</tr>
									<tr>
										<th scope="col" class="text-left">이용 및 보유기간</th>
							...
							<div class="mt-4">
								이 서비스는 개인정보 제3자 제공 동의가 필수인 서비스입니다.<br>
								동의하지 않으면 해당 서비스 이용에 제한이 있을 수 있습니다.
							</div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <p class="mt-2 mb-4 text-sm tracking-tight md:text-base">
                ...
                <!-- 상단배너추가 -->
	            <div class="top_banner_area dbapp popup">
	                <div class="width_area">
	                    <div class="icon_area">
	                        <img src="/html/page/index/assets/images/banner/store_dbapp.png" alt="돌봄앱 아이콘">
	                        <div class="txt">
	                            <span class="resp_block"><strong>간단한 테스트</strong>로</span>
	                            <span class="resp_block">더 <strong>빠르게 확인</strong>하세요!</span>
	                        </div>
	                    </div>
	
	                    <div class="rest_btn">
	                        <a href="" class="btn-dbapp01" data-bs-toggle="modal" data-bs-target="#dbapp_modal">앱 다운로드</a>
	                    </div>
	                </div>
	            </div>
	            <div class="h20"></div>
                <div class="modal-footer">
                    <a href="/membership/conslt/appl/list" class="flex-1 btn-warning large2 md:flex-none md:w-1/2">신청내역 보러가기</a>
                </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="bg-box-beige">
                            <div id="notified-consulting-guide-div" class="text-xl text-center">
                                진행중인 ((conslt_nm)) 상담이 있습니다. <br>
                                상담 내역을 확인하시겠습니까?
                            </div>
                        </div>
                    </div>
                    <div class="gap-1 modal-footer">
                        <button type="button" class="w-full btn-warning large2 md:w-1/2" data-bs-dismiss="modal" class="btn-close" onclick="location.href='/membership/conslt/appl/list';">상담내역 확인하기</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
        	...
        	function setMainFormInCommon() {
				...
				if (roc_selectedRecipient.relationCd === '001') {
					if (roc_mbrGender == 'M'){
						$('input[name=roc-main-gender]#gender-w')[0].checked = true;
					}else{
						$('input[name=roc-main-gender]#gender-m')[0].checked = true;
        	...
        	function relationCdChangeEvent() {
        		...
        		//L번호가 있을 때 수급자 이름을 텍스트 처리
        			...
        			if ($('#roc-main-recipient-nm').length === 0) {
        				$('#roc-main-div-rel-family .roc-recipient-nm').html('<input type="text" class="w-40 form-control form-small" id="roc-main-recipient-nm" placeholder="홍길동">');
        	...
        	function settingGenderInRocModal() {
        		...
        		if (roc_selectedRecipient) {
        			...
        			else if (roc_selectedRecipient.relationCd === '002'       //아버지
