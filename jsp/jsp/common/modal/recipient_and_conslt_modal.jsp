<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<div class="modal fade" id="pop-client-edit" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg">
					...
					<tbody>
						...
						<tr>
							<th scope="row">
                                <p>
									...
									<sup class="text-base text-danger md:text-lg">*</sup>
                                </p>
                            </th>
                            <td>
                                <select name="relationSelect" id="info-relationSelect" class="w-full form-control lg:w-8/12">
						...
						<tr class="wrapNo">
                            ...
                            <td>
                                ...
                                <div class="w-full form-group lg:w-8/12" id="input-rcperRcognNo">
						...
						<tr>
                            ...
                            <td><input type="text" class="w-full form-control lg:w-8/12 keycontrol phonenumber" id="info-tel" placeholder="010-1234-5678"></td>
                        </tr> 
						<tr>
                            <th scope="row">
                                <p>
			...
			<div class="mx-auto mt-4 modal-footer md:w-3/4">
				<button type="button" id="actionBtn" class="w-3/5 btn btn-primary large" onclick="requestAction();">등록하기</button>
				<button type="button" class="w-2/5 btn btn-outline-primary large" data-bs-dismiss="modal">취소하기</button>
			</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<%-- <div class="flex flex-col items-center justify-center"> --%>
						<div class="text-xl text-center" id="process-conslt-noti">
				...
				<div class="gap-2 modal-footer">
					<button type="button" class="w-full btn-warning large md:w-1/2" onclick="location.href='/membership/conslt/appl/list'">상담내역 확인하기</button>
					<!-- <button type="button" class="flex-initial btn btn-outline-primary large w-45" onclick="openNewConslt();">새롭게 진행하기</button> -->
				</div>
			</div>
		</div>
	</div>
    ...
    <div class="modal fade" id="modal-consulting-complated" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-footer">
                <a href="#" id="goConsltHist" class="flex-1 btn-large btn-warning md:w-70" onclick="location.href='/membership/conslt/appl/list'">신청내역 보러가기</a>
            </div>
            </div>
        </div>
    </div>
	...
	<div class="modal fade" id="regist-rcpt" tabindex="-1" aria-hidden="true">
	    <div class="modal-dialog modal-dialog-centered">
	        <div class="modal-content">
	            ...
	            <div class="modal-footer">
	                <button type="button" class="w-full btn btn-primary" onclick="clickRegistRecipient();">확인</button>
	            </div>
	        </div>
	    </div>
	</div>
