                                        ...
                                        <li id="regist-rcpt-lno">
                                            ...
                                            <div> 
                                                <label for="rcpt-lno" class="rcpt-lno">
                                                    <input type="text" id="no-rcpt-tab1-lno" placeholder="뒤의 숫자 10자리 입력" class="form-control w-48 keycontrol numberpositive" maxlength="10" oninput="checkAddRecipientBtnDisable();">
                                                </label>
                                                <span>입니다</span>
                                            </div>
                                        </li>
                                ...
                                <div class="tab tab2 hidden">
                                    <div class="flex flex-col gap-4">
                                        ...
                                        <div class="bg-white rounded-md p-5 regist-rcpt-lno-yes">
                                            ...
                                            <div>
                                                <label for="rcpt-lno" class="rcpt-lno">
                                                    <input type="text" id="no-rcpt-tab2-lno" placeholder="뒤의 숫자 10자리 입력" class="form-control input-lno keycontrol numberpositive" maxlength="10" oninput="checkAddRecipientBtnDisable();">
                                                </label>
                                                <span>입니다</span>
                                            </div>
                                        </div>
