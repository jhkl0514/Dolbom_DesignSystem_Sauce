            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="regist-rcpt-add-btn" type="button" class="flex-1 btn-warning large2 md:flex-none md:w-1/2 disabled" disabled onclick="addRecipientInSrNoReciModal();">등록하기</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal modal-default fade" id="rcpts-confirm" tabindex="-1" aria-hidden="true" style="z-index:10000;">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="flex-1 btn-warning large2 md:flex-none md:w-1/2" onclick="checkInRcptsConfirmModal();">확인</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-content-inner rcpts-select-content">
                        ...
                        <div class="modal-body">
                            <div class="flex justify-end">
                                <a href="/membership/info/recipients/list" class="w-auto gap-1 btn-black btn-small">수급자 관리 <i class="icon-arrow-right-white"></i></a>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button id="go-next-btn" type="button" class="flex-1 btn-warning large2 md:flex-none md:w-1/2" onclick="goNextInRcptsSelectModal();">진행하기</button>
                        </div>
                    </div>
                    <!--추가등록-->
                    ...
                    <div class="modal-content-inner regist-lno">
                        ...
                        <div class="modal-body">
                                    ...
                                    <div class="w-full">
                                        <div class="flex flex-col gap-4">
                                            ...
                                            <div class="p-5 bg-white rounded-md">
                                                <div class="mb-2 text-index1">요양인정번호는</div>
                                                <div>
                            ...
                            <div>
                                <p class="mt-8 mb-2 font-medium text-center">정보가 잘못되었나요?</p>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn-outline-black large2 rcpts-back">이전으로</button>
                            <button id="update-recipient-lno-btn" type="button" class="flex-1 btn-warning large2 md:flex-none md:w-1/2" onclick="registLnoInRecipient();">인정번호 등록하기</button>
                        </div>
                    </div>
                </div>
            </div>
