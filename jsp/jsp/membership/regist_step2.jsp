				...
				<table class="table-detail">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<p class="text-sm">
									띄어쓰기 없이 8~16자 영문, 숫자, 특수문자를 조합하여 입력해 주세요 (특수문자는 ! @ # $ % ^ &amp; * ( ) , . ? " : { } | &lt; &gt; 만 사용 가능)
								</p>
							</td>
						</tr>
						<tr>
...
$(function(){
	...
	const pswdChk = /^.*(?=.*\d)(?=.*[a-zA-Z])(?=.*[^a-zA-Z0-9]).*$/;
						...
						<tr class="wrapNo">
							...
							<td>
								...
								<div class="form-group w-full">
									...
									<input type="text" class="form-control w400 keycontrol numberpositive" id="rcperRcognNos" name="rcperRcognNos" maxlength="10" value="">
								</div>
							</td>
						</tr>
					</tbody>
	...
	$.validator.addMethod("specialCharCheck", function(value, element) {
        return specialCharChk.test(value);
    }, "! 특수문자는 ! @ # $ % ^ & * ( ) , . ? \" : { } | < > 만 사용 가능합니다.");
	...
	$("form#frmReg").validate({
	    ...
	    rules : {
	    	...
	    	, pswd : {required : true, pswdFrmChk : true, regex : pswdChk, specialCharCheck: true,  minlength : 8}
	    	, pswdConfirm : {required : true, equalTo : "#pswd", pswdFrmChk : true,  regex : pswdChk, specialCharCheck: true, minlength : 8}
	    ...
	    messages : {
	    	mbrId : {required : "! 아이디를 입력해 주세요" , regex : "! 4~15자 영문,숫자를 조합하여 입력해 주세요", remote:"! 사용할수 없는 아이디 입니다"}
			...
			, rcmdtnId : {regex : "! 4~15자 영문, 숫자를 조합하여 입력해주세요"}
