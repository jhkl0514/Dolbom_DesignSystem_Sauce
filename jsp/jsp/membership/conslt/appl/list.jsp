            ...
            <form action="./list" method="get" id="searchFrm" name="searchFrm" class="mypage-consult-search">
                <fieldset>
					...
					<dl class="search-current">
                        ...
                        <dd>
                            <select name="srchRecipientsNo" id="srchRecipientsNo" class="w-full form-control" value="${param.srchRecipientsNo}">
                        ...
                        <dd>
							<select name="srchConsltSttus" id="srchConsltSttus" class="w-full form-control">
					...
					<dl class="search-partner">
                        ...
                        <dd><input type="text" id="srchBplcNm" name="srchBplcNm" value="${param.srchBplcNm}" class="w-full form-control"></dd>
                    </dl>
                    <!--이전 코드 백업-->
                    <!-- <dl class="search-partner">
                        <dt><label for="srchBplcNm">상담 기관</label></dt>
                        <dd><input type="text" id="srchBplcNm" name="srchBplcNm" value="${param.srchBplcNm}" class="w-full form-control md:w-83"></dd>
                    </dl> -->
                    <!-- <dl class="search-current">
                        <dt><label for="srchConsltSttus">상담 접수 현황</label></dt>
                        <dd>
                            <select name="srchConsltSttus" id="srchConsltSttus" class="w-full form-control md:w-40">
                                <option value="">선택</option>
                                <option value="CS01" ${param.srchConsltSttus eq 'CS01'?'selected="selected"':''}>상담 신청 완료</option>
                                <option value="CS02" ${param.srchConsltSttus eq 'CS02'?'selected="selected"':''}>상담 기관 배정 완료</option>
                                <option value="CANCEL" ${param.srchConsltSttus eq 'CANCEL'?'selected="selected"':''}>상담 취소</option><%--상담취소 검색은 03, 04, 09가 포함되어야함 --%>
                    ...
                    <button type="submit" class="flex w-full mx-auto mt-6 btn-primary btn-animate md:w-43"><strong>검색</strong></button>
                </fieldset>
            </form>
                ...
                <c:forEach var="resultList" items="${listVO.listObject}" varStatus="status">
	                ...
	                <div class="mypage-consult-item">
						<dl class="item-current">
	                        <dt>수급자 성명</dt>
	                        <dd class="flex items-start justify-between gap-4">
