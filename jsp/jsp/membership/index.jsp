<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<main id="container" class="is-mypage-style">
        ...
        <div id="page-content">
            <h3 class="mypage-title" style="display: none;">나의 상담 관리</h3>
            <div class="grid grid-cols-1 gap-2.5 md:grid-cols-2 md:gap-6 lg:gap-10" style="display: none;">
            ...
            <h3 class="mypage-title">나의 정보 관리</h3>
